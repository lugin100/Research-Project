...
#SBATCH --time=0-5:00             # Allowed runtime in D-HH:MM
...
# Compute Phase
srun python3 Code/Evaluation.py  # srun will automatically pickup the configuration defined via `#SBATCH` and `sbatch` command line arguments  
